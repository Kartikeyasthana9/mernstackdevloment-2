...
const UserManager = () => {
    ...
    // thiss will fetch user data from backend
            ...
            <tbody>
                {
                    userList.map((user) => (
                        <tr>
                            ...
                            <td>{user.age}</td>
                            <td>
                                <button className='btn btn-outline-danger' onClick={() => { deleteUser(user._id) }}> <i className="fas fa-trash"></i> </button>
                            </td>
                            <td>
                                <button className='btn btn-outline-primary' onClick={() => { updateUser(user) }}> <i className="fas fa-pen"></i> </button>
                            </td>
                        </tr>
                    ))
                }
